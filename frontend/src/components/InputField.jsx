...
const InputField = ({label, placeholder,area, ...props}) => {
    const ref = useRef();
    const handleFocusOn = ()=>{
  ...
  return (
    <div>
        ...
        <div className='mt-2 w-full'>
            ...
            {area&&<textarea rows={5} onFocus={handleFocusOn} onBlur={handleFocusOff} ref={ref} {...props} placeholder={placeholder} className='w-full py-3 px-2 border-[1px] border-gray-300 rounded-lg outline-none focus:shadow-sm'/>}
        </div>
    </div>
  )
}
