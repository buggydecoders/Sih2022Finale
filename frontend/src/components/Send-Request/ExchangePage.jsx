...
const ExchangePage = () => {
  return (
    ...
    <div className='text-green-500 text-sm font-[600]'>Your resource request is currently ongoing...</div>
    <div className='mt-8 grid grid-cols-4 bg-white px-6 shadow-md py-4 rounded-md'>
      ...
      <div className=''>
        <div className='font-[700] text-sm text-gray-500'>Reputation Points</div>
