    ...
    <div className="flex flex-col px-8 w-7/12">
      ...
      <div className="py-4">
        <div className={`${error?'text-red-500':'text-[#383838]'} text-3xl font-bold  flex space-x-1`}>
          <BiLockOpenAlt />
          <h1>{error?'Error':'Faculty Login'}</h1>
        </div>
      ...
      <form onSubmit={(handleSubmit)} className="flex flex-col w-3/4 py-8">
        ...
        <div className="">
          <button
            type="submit"
            disabled={loading}
            className="my-2 py-5 px-4 bg-secondary text-white w-full transition ease-in duration-200 text-center text-base font-semibold shadow-md focus:outline-none focus:ring-2 focus:ring-offset-2  rounded-3xl "
          >
