  ...
  return (
    <div onClick={()=>setSelected(id)} className={`${isSelected?'shadow-xl scale-[1.03] -translate-x-[10px]':'hover:shadow-xl hover:scale-[1.03] hover:-translate-x-[10px]'} bg-white rounded-md w-full py-5 shadow-sm  transition-all cursor-pointer px-4`}>
        <div className='flex items-center gap-2'>
            ...
            <div>
                <div className={`${isSelected?'text-primary':'text-black'} font-semibold`}>Looking for a Classroom full of people</div>
                <div className={`${isSelected?'text-primary':'text-gray-500'} text-sm`}>We are looking for one with harry potter....</div>
            </div>
        </div>
        ...
        <div className='mt-5 flex items-center font-[500] justify-between'>
            <div className='text-gray-500 text-sm'><span className='text-black'>Posted : </span>3 Days ago</div>
